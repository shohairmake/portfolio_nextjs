...
var ImageAnimation = function ImageAnimation() {// anime.timeline({ loop: true })
  // .add({
  //     targets: '.line',
  //     scaleY: [0, 1],
  //     easing: 'easeOutExpo',
...
function Album(props) {
  ...
  var classes = useStyles(); // React.useEffect(() => {
  //     if (props.isActive) {
  //         ImageAnimation()
  //     }
  // }, [props.isActive])
  ...
  return __jsx(next_link__WEBPACK_IMPORTED_MODULE_4___default.a, {
    ...
    return __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__["GridListTile"], {
      ...
      className: "".concat(tile.title, " image"),
      src: tile.img,
      alt: tile.title,
      __self: _this,
      __source: {
...
//# sourceMappingURL=index.js.3ab388c3bc2875a6c57e.hot-update.js.map